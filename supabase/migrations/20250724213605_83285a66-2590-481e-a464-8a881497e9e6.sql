-- Fix the get_or_create_validation_workflow function to resolve column naming ambiguity
...
BEGIN
  ...
  -- If no workflow exists, create one using explicit table qualification
  INSERT INTO public.validation_workflows (
    validation_workflows.opportunity_id,
    validation_workflows.workflow_type,
    validation_workflows.status,
    validation_workflows.progress_percentage
  ) VALUES (
    p_opportunity_id,
    'standard',
    'not_started',
