-- Clean up the duplicate personal workspace and ensure user is in enterprise workspace
-- Remove the newly created personal workspace since user should be in enterprise workspace
-- Personal workspace: 7484edd8-b8bb-4c83-b3b2-3b29f6a6c94e
-- Enterprise workspace: ea714dd1-4792-4973-be21-46c5b89a3e5a

-- Step 1: Delete the free subscription for the duplicate personal workspace
DELETE FROM public.subscriptions 
WHERE organization_id = '7484edd8-b8bb-4c83-b3b2-3b29f6a6c94e';
...
WHERE id = '7484edd8-b8bb-4c83-b3b2-3b29f6a6c94e';
...
SELECT 
  'Final organizations for support@founderlens.io' as check_type,
  o.id,
  o.name,
  o.slug,
  om.role,
