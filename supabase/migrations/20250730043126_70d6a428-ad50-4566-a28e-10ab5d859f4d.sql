-- Add temporary admin override policy for debugging reddit_discussions visibility
CREATE POLICY "Admins can view all reddit discussions (temporary debug)" 
ON public.reddit_discussions 
FOR SELECT 
USING (is_admin());

-- Add detailed logging function for debugging RLS
