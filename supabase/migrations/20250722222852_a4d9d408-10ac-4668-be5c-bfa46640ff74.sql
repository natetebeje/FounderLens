...
-- Delete automated market intelligence first (references business_opportunities)
DELETE FROM public.automated_market_intelligence;

-- Delete validation tasks and workflows (reference business_opportunities)
...
-- Now delete business opportunities (after all dependent records are removed)
