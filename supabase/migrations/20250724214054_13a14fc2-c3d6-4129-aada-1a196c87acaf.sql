-- Fix SQL syntax error in get_or_create_validation_workflow function
-- Remove table qualification from INSERT column list (not allowed in PostgreSQL)
...
BEGIN
  ...
  -- If no workflow exists, create one (using bare column names in INSERT)
