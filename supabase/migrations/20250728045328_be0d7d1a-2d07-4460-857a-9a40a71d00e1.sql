-- Manual deletion of three problematic accounts (corrected column names)
-- User IDs to delete:
...
BEGIN
  ...
  LOOP
    ...
    -- 9. Delete workspace invitations (using correct column name)
    DELETE FROM public.workspace_invitations WHERE inviter_id = current_user_id;
