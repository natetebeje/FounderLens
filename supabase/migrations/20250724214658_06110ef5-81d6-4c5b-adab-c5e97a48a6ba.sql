-- Fix the get_or_create_validation_workflow function by simplifying the approach
-- Remove the problematic ON CONFLICT clause and use a simpler upsert pattern
